...
// AIActionItem provides a mock function with no fields
func (_m *Store) AIActionItem() store.AIActionItemStore {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for AIActionItem")
	}

	var r0 store.AIActionItemStore
	if rf, ok := ret.Get(0).(func() store.AIActionItemStore); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(store.AIActionItemStore)
		}
	}
...
// AIAnalytics provides a mock function with no fields
func (_m *Store) AIAnalytics() store.AIAnalyticsStore {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for AIAnalytics")
	}

	var r0 store.AIAnalyticsStore
	if rf, ok := ret.Get(0).(func() store.AIAnalyticsStore); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(store.AIAnalyticsStore)
		}
	}
...
// AIPreferences provides a mock function with no fields
func (_m *Store) AIPreferences() store.AIPreferencesStore {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for AIPreferences")
	}

	var r0 store.AIPreferencesStore
	if rf, ok := ret.Get(0).(func() store.AIPreferencesStore); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(store.AIPreferencesStore)
		}
	}
...
// AISummary provides a mock function with no fields
func (_m *Store) AISummary() store.AISummaryStore {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for AISummary")
	}

	var r0 store.AISummaryStore
	if rf, ok := ret.Get(0).(func() store.AISummaryStore); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(store.AISummaryStore)
		}
	}
